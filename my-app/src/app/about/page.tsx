  ...
  return (
    <div className="min-h-screen flex flex-col justify-between p-8">
      <div>
        ...
        <p className="text-lg">welcome! I appreciate you taking the time to learn about me.</p>
        <p> - </p>
        <p className="text-lg">I'm a builder and I care about building products that shape us into better humans.</p>
        <p> - </p>
